(function () {
    ...
    function zi_decode(array) {
        ...
        if (typeof array !== "object" || typeof array.length === "undefined") {
            throw new Error("Invalid argument type: Expected a byte array (Array or Uint8Array) to decode.");
        }
        if (!array.length) {
        ...
        function read() {
            ...
            console.debug("ziproto array:", array);
            throw new Error("Invalid byte value '" + byte + "' at index " + (pos - 1) + " in the protocol binary data (length " + array.length + "): Expecting a range of 0 to 255. This is not a byte array.");
        }
    ...
    if (typeof module === "object" && module && typeof module.exports === "object") {
        module.exports = ziproto;
    }
    else {
        // Global object
        window[window.ziprotoJsName || "ziproto"] = ziproto;
    }
